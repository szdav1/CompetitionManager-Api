...
public class CompetitorConverter {
    ...
    public static List<CompetitorList> convertModelsToList(final List<Competitor> competitors) {
        ...
        competitors.forEach(competitor -> list.add(new CompetitorList(competitor.getId(), competitor.getName(), competitor.getClub(), competitor.getBirthDate())));

        return list;
    }

    public static CompetitorRead convertModelToRead(final Competitor competitor) {
        return new CompetitorRead(competitor.getId(), competitor.getName(), competitor.getClub(), competitor.getBirthDate());
    }
